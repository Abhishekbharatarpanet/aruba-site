...
// $link = file_get_contents('https://ipinfo.io/'.$PublicIP.'/geo');
//var_dump($link);die();
...
try {
    ...
    $mail->addAddress('amardeep@shivalikjournal.com');
    //$mail->addCC('aggarwalrahul1920@gmail.com');
    $mail->isHTML(true);                                  //Set email format to HTML
    $mail->Subject = 'Tours To Aruba';
    $mail->Body    = '<html>
        <head><title>Contact Us Mailer</title></head>
        <body>
            <p><b>Hi </b>'.$name.'</p>
